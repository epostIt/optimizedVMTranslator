...
export declare class Commits extends BaseService {
    ...
    cherryPick(projectId: string | number, sha: string, branch: string, options?: Sudo): Promise<object>;
    comments(projectId: string | number, sha: string, options?: Sudo): Promise<import("../infrastructure").GetResponse>;
    create(projectId: string | number, branch: string, message: string, actions?: CommitAction[], options?: BaseRequestOptions): Promise<object>;
    createComment(projectId: string | number, sha: string, note: string, options?: BaseRequestOptions): Promise<object>;
    diff(projectId: string | number, sha: string, options?: Sudo): Promise<import("../infrastructure").GetResponse>;
    editStatus(projectId: string | number, sha: string, options?: BaseRequestOptions): Promise<object>;
