...
export declare class ProtectedTags extends BaseService {
    ...
    protect(projectId: string | number, tagName: string, options: BaseRequestOptions): Promise<object>;
    show(projectId: string | number, tagName: string, options: Sudo): Promise<import("../infrastructure").GetResponse>;
    unprotect(projectId: string | number, tagName: string, options: Sudo): Promise<object>;
}
