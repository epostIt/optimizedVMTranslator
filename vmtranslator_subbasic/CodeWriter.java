...
public class CodeWriter
{
   ...
   private void pushIndirect(String segment)
   {
      ...
      snippet("Go to address in register, get value of address, put in A, Add R13 value and this value, store in D");
      asm("@ " + base);
      asm("A = D+M");
      asm("D=M");
   ...
   private void inlineArithmetic(String command)
   {
      ...
      if (command.equals("add"))
      {
         ...
         // asm("@ R14");
         // asm("D = D+M");
         snippet("Store 2nd value in M and add");
         asm("@SP");
         asm("AM=M-1");
         asm("D=D+M");
      ...
      if (command.equals("sub"))
      {
         ...
         // snippet("Store 2nd value in M and sub");
         // asm("@SP");
         // asm("AM=M-1");
         // asm("D=D-M");
